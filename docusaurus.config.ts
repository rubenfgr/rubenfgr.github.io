...
const config: Config = {
  ...
  projectName: 'rubenfgr.github.io', // Usually your repo name.
  ...
  themeConfig: {
    ...
    //     },
    //   ],
    //   copyright: `Copyright © ${new Date().getFullYear()} Rubén Rosales - Construido con Docusaurus`,
    // },
    footer: {
      style: 'dark',
      logo: {
