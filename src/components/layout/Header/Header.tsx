...
export const Header: React.FC<HeaderProps> = ({
  title,
  subtitle,
  description = "UI/UX Developer. Passionate about creating modern and user-friendly web applications",
  imageSrc = "/img/profile.png"
}) => {
  return (
    <header className={styles.header}>
      <div className={styles.header__overlay}>
        <div className={styles.header__pattern}></div>
      </div>
      <div className={styles.header__content}>
        <div className={styles.header__text}>
          <p className={styles.header__greeting}>HELLO, I'M A</p>
          <h1 className={styles.header__title}>
            {title} <span className={styles.header__highlight}>{subtitle}</span>
          </h1>
          <p className={styles.header__description}>{description}</p>
          <div className={styles.header__cta}>
            <a href="#about" className={styles.header__button}>Ver mi trabajo</a>
            <Social />
          </div>
        </div>
      ...
      <div className={styles['custom-shape-divider-bottom-1743884776']}>
